      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <p class="mg-b-20 mg-sm-b-30">A form with a label on top of each form control.</p>
			<form action="{{ url('dashboard/package/insert/function') }}" method="post" enctype="multipart/form-data">
			  @csrf
				...
				<div class="row mg-b-25">
				  ...
				  <div class="col-lg-6">
					<div class="form-group">
					  ...
					  <textarea id="packag" name="package" class="form-control">{{ old('package') }}</textarea>
					</div>
				  </div><!-- col-6 -->
				  <div class="col-lg-12">
					<div class="form-group">
					  <label class="form-control-label">Offer: </span></label>
					  Yes <input type="radio" name="offer" value="1">
					  No <input type="radio" name="offer" value="o">
					</div>
				  </div><!-- col-12 -->
				</div><!-- row -->
