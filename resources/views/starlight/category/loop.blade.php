          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ $sn++ }}</td>
                  <td>{{ text_shorten($category_value->name, 50) }}</td>
                  <td class="text-center"><a href="{{ asset('uploads/'.$category_value->icon) }}" ><img src="{{ asset('uploads/'.$category_value->icon) }}" style="width:30px;height:30px;"/></a></td>
				    ...
				    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
					  <div class="btn-group" role="group">
						...
						<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						  <a class="dropdown-item" href="{{ url('dashboard/category/update/page/'.$category_value->id) }}">Update</a>
						  <a class="dropdown-item" href="{{ url('dashboard/category/remove/'.$category_value->id) }}">Delete</a>
						</div>
					  </div>
					</div>
				  </td>
